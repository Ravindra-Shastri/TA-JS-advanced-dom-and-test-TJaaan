...
var longDate = moment().format('MMMM Do YYYY, h:mm:ss a');
console.log(longDate);
var day = moment().format('dddd');
console.log(day);
var dateShort = moment().format('MMM Do YY');
console.log(dateShort);
var dateElt = '2020-01-01';
var aDate = moment(dateElt, 'YYYY-MM-DD', true);
var isValid = aDate.isValid();
console.log(isValid);
var anotherDate = "2020-14-01";
var bDate = moment(anotherDate, 'YYYY-MM-DD', true);
console.log(bDate.isValid());
var sevenDaysLater = moment().add(7, 'days').calendar();
console.log(sevenDaysLater);
var sevenMonthsLater = moment().add(7, 'months').calendar();
console.log(sevenMonthsLater);
var sevenYearsLater = moment().add(7, 'years').calendar();
console.log(sevenYearsLater);
var sevenDaysEarlier = moment().subtract(7, 'days').calendar();
console.log(sevenDaysEarlier);
var sevenMonthsEarlier = moment().subtract(7, 'months').calendar();
console.log(sevenMonthsEarlier);
var sevenYearsEarlier = moment().subtract(7, 'years').calendar();
...
var date2 = "2010-09-16";
console.log(checkIsAfter(date1, date2));
var date3 = "2010-01-01";
var date4 = "2018-01-01";
...
var chunkedArr = _.chunk(arr, 2);

console.log(chunkedArr);
var arr2 = ["a", "b", "", 0, false, true, 1, "c"];

var compactedArr = _.compact(arr2);
...
},{"moment":"node_modules/moment/moment.js","lodash":"node_modules/lodash/lodash.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
